...
| A18 | 7 | Controlled examples demonstrate workflow behavior | Future frozen example package | Future work | Pending | Do not claim until examples are executed and reviewed |
